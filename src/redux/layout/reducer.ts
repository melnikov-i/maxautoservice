...
const PageDataInitialState = {
  ...
  profit: [
    ...
    },
    {
      ...
      text: 'Широкий спекрт запасных частей: как оригинальных, '
    ...
    },
    {
      icon: 'f2b5',
      header: 'Гарантия',
      text: 'На все виды работ и запасные части мы предоставляем полную '
      + 'гарантию качества.',
    },
  ],
  description: {
    ...
    + 'обслуживанию, ремонту и диагностики всех моделей автомобиля '
  ...
  address: {
    ...
    address: 'Санкт-Петербург, Ириновский пр., д. 2',
    addressIcon: 'f041',
